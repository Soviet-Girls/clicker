...
async def message(event: MessageEvent):
    ...
    bot_message = "👥 Отправь пригласительную ссылку друзьям, чтобы получить бонус 10 000 SG₽ за каждого друга!\n\n"
    bot_message += "Также ты будешь получать бонусный 1% от добычи твоих друзей (он не будет отниматься у друзей).\n\n"
